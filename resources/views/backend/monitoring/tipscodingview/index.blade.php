    ...
    <div class="p-4 mx-auto">
      ...
      <section class="w-full px-3 mt-8 mb-5">
        <div class="breadcrumb">
          @include('backend.xbreadcrumb.monitoring.tipscoding-view')
        </div>
        ...
        <div class="x-border">
          <div class="flex flex-col items-center text-center">
            <x-md-header
              ...
              alt="image"
              title="Data tipscoding view"
              description="Monitoring data system tipscoding view"
            />
          </div>
                            ...
                            <div class="grid table-grid">
                              ...
                              <div class="table-header">
                                <div class="inline-flex items-center gap-x-2">
                                  ...
                                  <div class="search">
                                    <form action="/monitoring/tipscoding-view">
                                      <x-search
                                        search="tipscodings"
