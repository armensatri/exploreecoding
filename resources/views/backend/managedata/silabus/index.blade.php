          ...
          <div>
            ...
            @foreach ($paths as $path)
              <div class="group relative flex gap-x-5">
                ...
                <!-- Right Content -->
                <div class="grow pb-8 group-last:pb-20">
                  <div class="flex items-center gap-2">
                    <div class="font-semibold text-sm text-gray-800 dark:text-neutral-200">
                      {{ $path->name }}
                    </div>

                    <div class="text-xs text-gray-600 dark:text-neutral-400 {{ $path->status->bg }} {{ $path->status->text }} px-2 py-[2px] rounded-lg border border-gray-300">
                      {{ $path->status->name }}
                    </div>
                  </div>

                  <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400 max-w-lg">
                    {{ $path->description }}
                  </p>
