            ...
            <div class="lg:col-span-5 lg:col-start-1">
              ...
              <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-neutral-400">
                  ExploreCoding membantu kamu belajar programming secara terstruktur melalui path, roadmap, playlist, dan post/materi yang mudah dipahami.
                </p>
              </div>
              <!-- End Title -->
              ...
              <blockquote class="relative">
                <svg class="absolute top-0 text-gray-200 transform -translate-x-6 -translate-y-8 start-0 size-16 dark:text-neutral-800" viewBox="0 0 16 16" fill="none" aria-hidden="true">
