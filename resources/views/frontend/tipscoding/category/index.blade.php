    ...
    <div class="max-w-2xl mx-auto mt-32 xl:max-w-4xl">
      <div class="text-center">
        ...
        <p
          ...
          Kumpulan categori artikel exploreecoding berisi tips coding praktis panduan sederhana dan wawasan pengembangan pengetahuan
        </p>
      </div>
    </div>
      ...
      <span
        ...
        <div
          ...
          @foreach ($categories as $category)
            <div>
              <a href="{{ route(
                'ec-tipscoding.categori', $category->url) }}">
                <button
