  ...
  <div class="relative px-6 bg-sky-100 pt-14 lg:px-8">
    <div class="mt-16">
      <div class="mx-auto max-w-7xl">
        @include(
          'frontend.xbreadcrumb.tipscoding-category.category'
        )
      </div>
    </div>
    ...
    <div class="py-20 mt-8">
      <div class="gap-x-20">
        <section class="px-4 py-10 mx-auto max-w-7xl">
          ...
          @include(
            'frontend.tipscoding.tipscoding-category._index-semua-tips'
          )

          @include(
            'frontend.tipscoding.tipscoding-category._index-select-category'
          )

          @include(
            'frontend.tipscoding.tipscoding-category._index-sebagian-category'
          )
          ...
          <div class="mb-3 mt-28">
            ...
            <p class="max-w-3xl mt-3 ml-1 text-lg text-gray-600">
              {{ $tipscodings->total() }} Tips -- <span class="text-blue-600">{{ $category->name }}</span> -- untuk pengembangan wawasan dan pengetahuan
            </p>
          ...
          <div class="grid grid-cols-1 gap-10 md:grid-cols-2
            ...
            @foreach ($tipscodings as $tipscoding)
              @include(
                'frontend.tipscoding.tipscoding-category._index-card-tipscoding'
              )
            @endforeach
          </div>
        </section>
