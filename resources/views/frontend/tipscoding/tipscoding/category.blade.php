  ...
  <div class="relative px-6 bg-sky-100 pt-14 lg:px-8">
    ...
    <div class="py-20">
      <section class="px-4 py-10 mx-auto max-w-7xl">
        ...
        @include(
          'frontend.tipscoding.tipscoding._category.index-tipscoding'
        )

        @include(
          'frontend.tipscoding.tipscoding._category.select-category'
        )

        @include(
          'frontend.tipscoding.tipscoding._category.sebagian-category'
        )
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-3">
          @foreach ($tipscodings as $tipscoding)
            @include(
              'frontend.tipscoding.tipscoding._category.card'
            )
          @endforeach
        </div>
