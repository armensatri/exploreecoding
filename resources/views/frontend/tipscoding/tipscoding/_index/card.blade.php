<div class="p-5 transition border border-gray-300 rounded-3xl">
  ...
  <div class="flex items-center gap-2">
    <a href="{{ route(
      ...
      <span
        class="flex items-center px-2 py-1 text-[13px] font-medium text-blue-600 rounded-[10px] bg-white tracking-wider border border-blue-400 hover:bg-gray-200 hover:text-black">
        <img
    ...
    <a href="{{ route('ec-tipscoding.show', [
      ...
      <div class="flex items-center">
        <div class="hs-tooltip [--placement:auto]">
          <div
            class="relative flex items-center px-2 py-1 text-sm font-semibold tracking-wide text-black bg-blue-300 border border-gray-400 rounded-[10px] shadow-xs hs-tooltip-toggle hover:bg-blue-600 hover:text-white">
