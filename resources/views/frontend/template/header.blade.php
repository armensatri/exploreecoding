<header x-data="{ openSidebar: false }"
  ...
  <nav aria-label="Global"
    ...
    <!-- MENU WEB -->
    @include('frontend.template._temp.menu-web')

    <!-- MENU AUTH -->
    @include('frontend.template._temp.menu-auth')
  </nav>
  ...
  <div x-show="openSidebar"
    ...
    <div class="fixed inset-y-0 right-0 z-50 w-full px-6 py-5 overflow-y-auto rounded-tl-3xl bg-sky-50 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
      <div class="flex items-center justify-between">
        <!-- MENU AUTH MOBILE -->
        @include('frontend.template._temp.menu-auth-mobile')
      ...
      <!-- MENU MOBILE -->
      @include('frontend.template._temp.menu-mobile')
    </div>
  </div>
</header>
