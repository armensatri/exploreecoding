  ...
  <div>
    <div class="hs-dropdown [--strategy:static]
      ...
      <div role="menu"
        ...
        class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-150 hs-dropdown-open:opacity-100 opacity-0 relative w-full min-w-60 hidden z-10 top-full inset-s-0 before:absolute before:-top-5 before:inset-s-0 before:w-full before:h-5" >
